...
try:
 ...
 class Sniper:
    ...
    def check_version(self):
        ...
        self._print_stats()
        response = requests.get("https://raw.githubusercontent.com/isai-Narcicista/isaisniper/main/raw")
    ...
    def _print_stats(self) -> None:
        ...
        function = getattr(module, '_print_stats', 'change_tittle_color' )
        function(self)
